...
import com.example.todomaster.data.TaskDao;
...
@TypeConverters({Converter.class})                                                                  //passes the database through the converter class before/after adding data.
    ...
    public static final RoomDatabase.Callback sRoomDatabaseCallBack = new RoomDatabase.Callback(){
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            databaseWriterExecutor.execute( () -> {
                ...
                taskDao.deleteAll(); //Delete Everything in the table

                //Writing in our table
            });
        }
    };
